...
public class RecentActivityWindow extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RecentActivityWindow
     */
    ...
    private void updateTable()
    {
        ...
        try {
            ...
            for(int i=0;;i++)
            {
                if(!results.next())
                    return;
                jTable1.setValueAt(results.getString(5), i, 0);
                jTable1.setValueAt(results.getString(4), i, 1);
                jTable1.setValueAt(results.getString(3), i, 2);
                jTable1.setValueAt(results.getString(1), i, 3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecentActivityWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
