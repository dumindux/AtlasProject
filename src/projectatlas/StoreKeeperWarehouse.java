 ...
 */
public class StoreKeeperWarehouse extends javax.swing.JFrame {

    /**
     * Creates new form StoreKeeperWarehouse
     */
    public StoreKeeperWarehouse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StoreKeeperWarehouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StoreKeeperWarehouse().setVisible(true);
            }
        });
    }
